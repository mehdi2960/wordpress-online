            ...
            <div class="main-single main-pro">
                ...
                <div class="product-thumbnail">
                    <figure>
                        ...
                        $poster_pro = get_post_meta(get_the_ID(), 'pishro_poster_product', true);
            ...
            <div class="sidebar side-pro">
                <div class="single-widget">
                    <div class="pro-price">
                        ...
                        <?php
                        global $product;
                        echo esc_attr(apply_filters('woocommerce_product_price_class', 'price')); ?>"><?php echo $product->get_price_html(); ?>
                        </p>
                    </div>
                    <?php
                    $id = $product->id;
                ...
                <div class="single-widget">
                    <div class="total-buyers">
                        ...
                        تعداد دانشجو :
                        <span>
                            <?php echo get_post_meta($id, 'total_sales', true); ?>
                        </span>
                    </div>
